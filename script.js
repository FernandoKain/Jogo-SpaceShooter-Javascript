...
// Movimentação da Nave Up/Down e Disparo
...
// Função para movimentação para cima
function moveUp(){
...
// Função para movimentação para baixo
function moveDown(){
    let topPosition = getComputedStyle(yourShip).getPropertyValue('top');
...
function moveLaser(laser){
    let laserInterval = setInterval(() =>{
        ...
        let aliens = document.querySelectorAll('.alien');
         ...
         // verificando se cada alien foi atingido
...
function createAliens(){
    ...
    let alienSprite = aliensImg[Math.floor(Math.random()*aliensImg.length)]; // sorteio de imagens dos aliens
